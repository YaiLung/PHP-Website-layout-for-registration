    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            <div class="inner cover">
                ...
                <p class="lead">This layout is proprietary https://github.com/YaiLung</p>
                <div id="clock"></div>
                <p class="lead"><a href="/registertion.php" class="btn btn-lg btn-default">Register</a></p>
                <p class="lead"><a href="/login.php" class="btn btn-lg btn-default">Login</a></p>
            </div>
